...
{
    public class AccVoucherEntryViewModel_dsk
    {
       ...
       // public string TrxDtMsg { get; set; }
        ...
        // mahfuz
        public string StrTrxDate { get; set; }
        public decimal? Amount { get; set; }

        [Display(Name = "Sender Bank")]
        public int SenderBankAccId { get; set; }

        [Display(Name = "Receiver Office")]
        public int? ReceiverOfficeId { get; set; }

        [Display(Name = "Receiver Bank")]

        public int? ReceiverBankAccId { get; set; }

        public IEnumerable<SelectListItem> SenderBankList { get; set; }
    }
}