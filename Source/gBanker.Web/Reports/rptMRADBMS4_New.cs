...
namespace gBanker.Web.Reports {
    ...
    public class rptMRADBMS4_New : ReportClass {
        
        public rptMRADBMS4_New() {
        }
        
        public override string ResourceName {
            get {
                return "rptMRADBMS4_New.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "gBanker.Web.Reports.rptMRADBMS4_New.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptMRADBMS4_New : Component, ICachedReport {
        
        public CachedrptMRADBMS4_New() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptMRADBMS4_New rpt = new rptMRADBMS4_New();
            rpt.Site = this.Site;
            return rpt;
        }
