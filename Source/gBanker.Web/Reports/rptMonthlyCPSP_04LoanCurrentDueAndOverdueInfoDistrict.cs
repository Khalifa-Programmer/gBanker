...
namespace gBanker.Web.Reports {
    ...
    public class rptMonthlyCPSP_04LoanCurrentDueAndOverdueInfoDistrict : ReportClass {
        
        public rptMonthlyCPSP_04LoanCurrentDueAndOverdueInfoDistrict() {
        }
        
        public override string ResourceName {
            get {
                return "rptMonthlyCPSP_04LoanCurrentDueAndOverdueInfoDistrict.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "gBanker.Web.Reports.rptMonthlyCPSP_04LoanCurrentDueAndOverdueInfoDistrict.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptMonthlyCPSP_04LoanCurrentDueAndOverdueInfoDistrict : Component, ICachedReport {
        
        public CachedrptMonthlyCPSP_04LoanCurrentDueAndOverdueInfoDistrict() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptMonthlyCPSP_04LoanCurrentDueAndOverdueInfoDistrict rpt = new rptMonthlyCPSP_04LoanCurrentDueAndOverdueInfoDistrict();
            rpt.Site = this.Site;
            return rpt;
        }
