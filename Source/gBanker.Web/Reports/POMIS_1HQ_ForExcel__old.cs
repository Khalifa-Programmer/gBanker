...
namespace gBanker.Web.Reports {
    ...
    public class POMIS_1HQ_ForExcel__old : ReportClass {
        
        public POMIS_1HQ_ForExcel__old() {
        }
        
        public override string ResourceName {
            get {
                return "POMIS_1HQ_ForExcel__old.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "gBanker.Web.Reports.POMIS_1HQ_ForExcel__old.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPOMIS_1HQ_ForExcel__old : Component, ICachedReport {
        
        public CachedPOMIS_1HQ_ForExcel__old() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            POMIS_1HQ_ForExcel__old rpt = new POMIS_1HQ_ForExcel__old();
            rpt.Site = this.Site;
            return rpt;
        }
