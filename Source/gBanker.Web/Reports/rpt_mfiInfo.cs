...
namespace gBanker.Web.Reports {
    ...
    public class rpt_mfiInfo : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "gBanker.Web.Reports.rpt_mfiInfo.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedrpt_mfiInfo : Component, ICachedReport {
        
        public Cachedrpt_mfiInfo() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rpt_mfiInfo rpt = new rpt_mfiInfo();
            rpt.Site = this.Site;
            return rpt;
        }
