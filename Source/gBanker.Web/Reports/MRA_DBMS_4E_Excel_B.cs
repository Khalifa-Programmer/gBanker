...
namespace gBanker.Web.Reports {
    ...
    public class MRA_DBMS_4E_Excel_B : ReportClass {
        
        public MRA_DBMS_4E_Excel_B() {
        }
        
        public override string ResourceName {
            get {
                return "MRA_DBMS_4E_Excel_B.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "gBanker.Web.Reports.MRA_DBMS_4E_Excel_B.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedMRA_DBMS_4E_Excel_B : Component, ICachedReport {
        
        public CachedMRA_DBMS_4E_Excel_B() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            MRA_DBMS_4E_Excel_B rpt = new MRA_DBMS_4E_Excel_B();
            rpt.Site = this.Site;
            return rpt;
        }
