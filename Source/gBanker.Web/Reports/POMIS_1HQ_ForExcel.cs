...
namespace gBanker.Web.Reports {
    ...
    public class POMIS_1HQ_ForExcel : ReportClass {
        
        public POMIS_1HQ_ForExcel() {
        }
        
        public override string ResourceName {
            get {
                return "POMIS_1HQ_ForExcel.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "gBanker.Web.Reports.POMIS_1HQ_ForExcel.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPOMIS_1HQ_ForExcel : Component, ICachedReport {
        
        public CachedPOMIS_1HQ_ForExcel() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            POMIS_1HQ_ForExcel rpt = new POMIS_1HQ_ForExcel();
            rpt.Site = this.Site;
            return rpt;
        }
