...
namespace gBanker.Web.Reports {
    ...
    public class RebateInfo1 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "gBanker.Web.Reports.RebateInfo1.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRebateInfo1 : Component, ICachedReport {
        
        public CachedRebateInfo1() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RebateInfo1 rpt = new RebateInfo1();
            rpt.Site = this.Site;
            return rpt;
        }
